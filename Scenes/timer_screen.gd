...
@onready var garlic: TextureRect = $Background/HeartContainer/Heart
@onready var garlic_2: TextureRect = $Background/HeartContainer/Heart2
@onready var garlic_3: TextureRect = $Background/HeartContainer/Heart3
@onready var garlic_4: TextureRect = $Background/HeartContainer/Heart4
@onready var garlic_5: TextureRect = $Background/HeartContainer/Heart5
